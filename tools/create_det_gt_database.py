...
def parse_args():
    ...
    parser.add_argument(
        '--dataset_name',
        dest='dataset_name',
        help='Name of the dataset: nuscenes, kitti, or apollo.',
        type=str)
    parser.add_argument(
        '--dataset_root',
        dest='dataset_root',
...
def main(args):
    ...
    elif args.dataset_name.lower() == 'apollo':
        generate_apollo_gt_database(args.config)
    else:
        raise ValueError(
